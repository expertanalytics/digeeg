...
class Line:
    ...
    def __post_init__(self):
        ...
        # TODO: Is it possible to treat the dataclass as a tuple directly?
    ...
    def __xor__(self, other):
        # Intersect
        # TODO: I am not sure this is the most intuitive interpretation of XOR
        A = np.vstack(
            (astuple(self),
             astuple(other))
        )
